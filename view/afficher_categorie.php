...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <hr>
	<body>
	    <button><a href="afficher_categorie.php">Afficher un categorie</a></button>
		...
		<table border="1" align="center">
			...
			<tr>
				...
				<td>
					<a href="Supprimer_categorie.php? id=<?php echo $categorie['id']; ?>">Supprimer</a>
				</td>
                <td>
					<a href="modifier_produit.php? id=<?php echo $categorie['nom']; ?>">modifier</a>
				</td>
			</tr>
			<?php
				}
