...
<div class="col-lg-4 col-md-6 text-center 5">
                <div class="single-product-item">
                    ...
                    <p class="product-price"><span>prix</span> <td><?php echo $produit['prix']; ?> DT</td></p>
                    <a href="cart.html" class="cart-btn"><i class="fas fa-Eventsping-cart"></i> BUY</a>
                </div>
            </div>
            <?php
				}
...
<head></head>
	...
	<div class="col-lg-4 col-md-6 text-center 1">
			...
			<br>     
                    <a href="cart.html" class="cart-btn"><i class="fas fa-Eventsping-cart"></i> add to cart</a>
                </div>
            </div>
				</div>
			<?php
