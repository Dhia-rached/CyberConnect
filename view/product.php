		...
		<div class="container">
                ...
                <div class="col-md-12">
                    <div class="product-filters">
                        <ul>
                            ...
                            <li data-filter=".ADDIDAS">ADDIDAS</li>
			...
			<div class="row product-lists">
				...
				<div class="col-lg-4 col-md-6 text-center PUMA">
					<div class="single-product-item">
						<div class="product-image">
							<a href="single-product.html"><img src="assets/img/products/addidas1.WEBP" alt=""></a>
						</div>
						<h3>PUMA</h3>
				...
				<div class="col-lg-4 col-md-6 text-center">
					<div class="single-product-item">
						...
						<h3>NIKE</h3>
						<p class="product-price"><span>Per unit</span> 50$ </p>
						<a href="cart.html" class="cart-btn"><i class="fas fa-shopping-cart"></i> Add to Cart</a>
					</div>
				</div>
				<div class="col-lg-4 col-md-6 text-center">
					<div class="single-product-item">
						...
						<h3>ADDIDAS</h3>
						<p class="product-price"><span>Per unit</span> 45$ </p>
						<a href="cart.html" class="cart-btn"><i class="fas fa-shopping-cart"></i> Add to Cart</a>
					</div>
				</div>
				<div class="col-lg-4 col-md-6 text-center NIKE">
					<div class="single-product-item">
						...
						<h3>NIKE</h3>
						<p class="product-price"><span>Per unit</span> 80$ </p>
						<a href="cart.html" class="cart-btn"><i class="fas fa-shopping-cart"></i> Add to Cart</a>
					</div>
				</div>
			</div>
