<?php
    ...
    if (isset($_POST['tri']))
    {
        ...
        {$listecategorie=$categoriec->triPrix();}
        if($_POST['tri']=="prixDESC")
        {$listecategorie=$categoriec->triPrixDesc();}
        if($_POST['tri']=="categorie")
       { $listecategorie=$categoriec->triProduit(); }
    }
?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-1 text-gray-800">Afficher Categorie</h1>
                    <button><a href="AjouterCategories.php">Ajouter une catégorie</a></button>
			...
			<tr>
				...
				<td>
					<form method="POST" action="ModifierCategories.php">
						...
						<input type="hidden" value="<?=$catal['id_categorie']?>" name="id_categorie">
						<!-- <input type="" value="" name="reference"> -->
					</form>
				</td>
				<td>
					<a href="SupprimerCategories.php? id_categorie=<?php echo $catal['id_categorie']; ?>">Supprimer</a>
				</td>
			</tr>
...
<form action="" method="POST">
    ...
    <option prixASC></option>
        <option value="prixASC">nbrEventASC</option>
        <option value="prixDESC">nbrEventDESC</option>
