...
include "../config.php";
    ...
    */
    ...
    try {
      ...
      $result = $db->query('SELECT nomCategorie,nbrEvent FROM categorie');
      ...
      */
      ...
      $table['cols'] = array(
        ...
        */
        ...
        array('label' => 'nomCategorie', 'type' => 'string'),
        array('label' => 'nbrEvent', 'type' => 'number')
        ...
        foreach($result as $r) {
          ...
          $temp[] = array('v' => (string) $r['nomCategorie']); 

          // Values of each slice

          $temp[] = array('v' => (int) $r['nbrEvent']); 
          $rows[] = array('c' => $temp);
        }
