    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="Gcommande.php">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <table class="table table-striped" data-swf-path="assets/vendor/jquery-datatables/extras/TableTools/swf/copy_csv_xls_pdf.swf">
                     ...
                     <thead>
                             ...
                             <th style="color:rgb(131, 41, 148)">trie par Date</th>
                            <th style="color:rgb(131, 41, 148)">trie par adresse</th>
                            <th style="color:rgb(131, 41, 148)">trie par montant</th>
