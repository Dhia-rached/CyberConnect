						      ...
						      <div class="card-body">
						         <div class="billing-address-form">
						        	<form action="" method="POST">
						        		<p><input type="text" name="idc" id="idc" maxlength="20" value="<?PHP echo $idcs ?> " name="idc"></p>
						        		<p><input type="text" name="idt" id="idt" maxlength="20" value="<?PHP echo $idts ?> " name="idt"></p>
						        		<p><input type="datetime-local" name="dateres" id="dateres" format="yyyy-MM-ddThh:mm:ss"  maxlength="20"></p>
