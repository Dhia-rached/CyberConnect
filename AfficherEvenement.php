<?php
    ...
    if (isset($_POST['tri']))
    {
        ...
        {$listeevenement=$evenementC->triPrix();}
        if($_POST['tri']=="prixDESC")
        {$listeevenement=$evenementC->triPrixDesc();}
        if($_POST['tri']=="categorie")
       { $listeevenement=$evenementC->triProduit(); }
    }
?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-1 text-gray-800">Afficher un evenement</h1>
                    

                        <button><a href="AjoutEvenement.php">Ajouter un evenement</a></button>
		...
		<table border="1" align="center">
			...
			<tr>
                ...
                <td>
                        <?php $img=$evenement['img'];
                        echo "<img src='$img'>"; ?>
                        <style> img{width:190px;height:190px;}</style>
                </td>
				<td>
				...
				<td>
					<a href="SupprimerEvenement.php? reference=<?php echo $evenement['reference']; ?>">Supprimer</a>
				</td>
			</tr>
			<?php
				}
