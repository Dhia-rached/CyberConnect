<?php
     ...
     include '../controller/imgC.php';
 
     $imgc=new imgC();
 $listeimg=$imgc->afficherimg(); 
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">Sport.com</div>
            </a>
            ...
            <li class="nav-item active">
                ...
                <div id="collapseUtilities" class="collapse show" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="AjoutEvenement.php">Ajouter un evenement</a>
                        <a class="collapse-item" href="AfficherEvenement.php">Afficher un evenement</a>
                        <a class="collapse-item" href="ModifierEvenement.php">Modifier un evenement</a>
                        <a class="collapse-item" href="SupprimerEvenement.php">Supprimer un évenement</a>
                    </div>
                </div>
            </li>
            <li class="nav-item active">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-1 text-gray-800">Ajouter un évenement</h1>

                        <button><a href="AfficherEvenement.php">Retour à la liste des evenement</a></button>
        <hr>
        ...
        <form action="" method="POST">
            <table border="1" align="center">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input type="date" name="date" id="date"min="2022-04-28">
            ...
            ?>
            <option value="<?php echo $categorie['id_categorie']; ?>"><?php echo $categorie['nomCategorie']; ?></option>
            <?php
            }
            ?> </td>
                </tr>
            ...
            ?>
            <option value="<?php echo $img['img']; ?>"><?php echo $img['nom']; ?></option>
            <?php
            }
            ?> </td>
                </tr>    
